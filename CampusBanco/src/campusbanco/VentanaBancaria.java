...
public class VentanaBancaria extends javax.swing.JFrame {
    ...
    ArrayList<CuentaBancaria> listaUsuarios = new ArrayList<CuentaBancaria>();
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnGuardarD, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 170, -1, 30));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 20, 290, 220));
        ...
        jPanel3.add(cboMovimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 50, 130, 30));
        ...
        jPanel4.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, -1, -1));
        ...
        jPanel4.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 160, -1, -1));
        jPanel4.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 190, -1, -1));

        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 410, 300, 170));

        jLabel17.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel17.setText("Saldo");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 480, -1, -1));
        ...
        getContentPane().add(lblSaldo, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 480, 130, 30));
    ...
    public void llenarComboUsuario(){
        ...
        int i = 0;
        for(CuentaBancaria c : listaUsuarios){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaBancaria().setVisible(true);
            }
        });
    }
