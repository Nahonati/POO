...
public class VentanaAhorro extends javax.swing.JFrame {
    
    ArrayList<CuentaAhorro> listaUsuarios = new ArrayList<CuentaAhorro>(); 
    CuentaAhorro usuario; 
    Cuenta cuenta; 
    final double tasaInteres = 0.16;

    public VentanaAhorro() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblMontoIn = new javax.swing.JLabel();
        ...
        jPanel3.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 30, -1, -1));
        ...
        jPanel3.add(cboMovimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 50, 130, 30));

        jLabel12.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel12.setText("Monto:");
        jPanel3.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 30, -1, -1));
        jPanel3.add(txtMontoM, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 50, 90, 30));
        ...
        jPanel3.add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(625, 50, 150, 30));
        ...
        jLabel16.setText("Monto con Interes:");
        ...
        jPanel4.add(lblInteres, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 170, -1, -1));

        jLabel19.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel19.setText("Tasa de Interes");
        jPanel4.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, -1, -1));
        jPanel4.add(lblMontoIn, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 200, -1, -1));

        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 410, 300, 250));

        jLabel17.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel17.setText("Saldo:");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 520, -1, -1));
        ...
        getContentPane().add(lblSaldo, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 520, 110, 30));
    ...
    public void llenarComboUsuario(){
        ...
        int i = 0;
        for(CuentaAhorro c : listaUsuarios){
    ...
    public void MostrarDatos(){
        ...
        if(usuario.getMiscuentas().size()>0){
            Cuenta CuentaAhorro = usuario.getMiscuentas().get(0);
            double saldoCuenta = CuentaAhorro.getMontoInicial();
            lblMontoInicial.setText(Moneda(CuentaAhorro.getMontoInicial()));
            lblInteres.setText("16%");
            lblMontoIn.setText(Moneda(CuentaAhorro.getMontoInicial() * tasaInteres + CuentaAhorro.getMontoInicial()));  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAhorro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaAhorro().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblMontoIn;
